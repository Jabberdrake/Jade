...
import dev.jabberdrake.jade.menus.implementations.SettlementSettingsMenu;
...
public class SettlementSettingsCommand {

    public static LiteralCommandNode<CommandSourceStack> buildCommand(final String label) {
        return Commands.literal(label)
                .requires(sender -> sender.getExecutor() instanceof Player)
                .executes(SettlementSettingsCommand::runCommandWithoutArgs)
                .build();
    }
    ...
    public static int runCommandWithoutArgs(CommandContext<CommandSourceStack> context) {
        ...
        new SettlementSettingsMenu(focus).open(player);
