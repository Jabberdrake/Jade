...
public class TitleAllowCommand {
    ...
    public static int runCommand(CommandContext<CommandSourceStack> context) {
        ...
        if (Bukkit.getPlayer(targetName) == null) {
            ...
            player.sendMessage(TextUtils.composePlainErrorMessage("You already own the title, silly!"));
            return Command.SINGLE_SUCCESS;
        } else if (title.isAvailableTo(targetUUID)) {
            player.sendMessage(TextUtils.composePlainErrorMessage("This player can already use the specified title!"));
            return Command.SINGLE_SUCCESS;
        }
